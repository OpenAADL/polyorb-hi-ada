...
procedure Headers_PO_HI is
   ...
   "@COPYRIGHT@" &
   "--                                                                          --" & ASCII.LF &
   "-- PolyORB-HI is free software; you can redistribute it and/or modify under --" & ASCII.LF &
   ...
   "-- sion. PolyORB-HI is distributed in the hope that it will be useful, but  --" & ASCII.LF &
   ...
   "--                                                                          --" & ASCII.LF &
   "--              PolyORB-HI/Ada is maintained by the OpenAADL team           --" & ASCII.LF &
